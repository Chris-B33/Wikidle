export function buildTableOfContents(wikipediaContainer, tableOfContents) {
    console.log("Building TOC...");
    tableOfContents.innerHTML = "";
    const headings = wikipediaContainer.querySelectorAll("h2, h3, h4");
    const counts = [0, 0, 0];
...
function setupTableOfContentsObserver(wikipediaContainer, tableOfContents) {
    const headings = wikipediaContainer.querySelectorAll("h2, h3, h4");
